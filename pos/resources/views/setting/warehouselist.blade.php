												...
												<div class="card-body" >
													<div >
														<div class=" table-responsive" id="printableTable">
															<table id="warehouseListTable" class="display ">
																...
																@endphp
																	...
																	<tr class="kt-table-row kt-table-row-level-0">
																		<td  >{{$number++}}</td>
																		<td>
																			$warehouselists as $warehouse
																		</td>
																		<td>$warehouselists as $phone_number</td>
																		<td>$warehouselists as $email</td>
																		<td>$warehouselists as $address</td>
																		<td>$warehouselists as $number_of_product</td>
																		<td>$warehouselists as $stock_quantity</td>
																		<td>
