                ...
                <div class="card card-custom gutter-b bg-white border-0">
                    <div class="card-header align-items-center border-0">
                        <div class="card-title mb-0">
                            <h3 class="card-label mb-0 font-weight-bold text-body">Edit Sale - {{ $sale->reference_no }}</h3>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="reference_no" name="reference_no" 
                                               value="{{ old('reference_no', $sale->reference_no) }}" required>
                                        @error('reference_no')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="biller_id" name="biller_id" 
                                               value="{{ old('biller_id', $sale->biller_id) }}" required>
                                        @error('biller_id')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="sale_status" name="sale_status" required>
                                            <option value="0" {{ old('sale_status', $sale->sale_status) == '0' ? 'selected' : '' }}>Draft</option>
                                            <option value="1" {{ old('sale_status', $sale->sale_status) == '1' ? 'selected' : '' }}>Completed</option>
                                            <option value="2" {{ old('sale_status', $sale->sale_status) == '2' ? 'selected' : '' }}>Pending</option>
                                        </select>
                                        @error('sale_status')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="payment_status" name="payment_status" required>
                                            <option value="0" {{ old('payment_status', $sale->payment_status) == '0' ? 'selected' : '' }}>Due</option>
                                            <option value="1" {{ old('payment_status', $sale->payment_status) == '1' ? 'selected' : '' }}>Paid</option>
                                            <option value="2" {{ old('payment_status', $sale->payment_status) == '2' ? 'selected' : '' }}>Partial</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="grand_total" name="grand_total" 
                                               value="{{ old('grand_total', $sale->grand_total) }}" required>
                                        @error('grand_total')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="shipping_cost" name="shipping_cost" 
                                               value="{{ old('shipping_cost', $sale->shipping_cost) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="sale_note" name="sale_note" rows="3">{{ old('sale_note', $sale->sale_note) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="staff_note">Staff Note</label>
                                        <textarea class="form-control" id="staff_note" name="staff_note" rows="3">{{ old('staff_note', $sale->staff_note) }}</textarea>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="product-row row mb-3">
                                            ...
                                            <div class="col-md-2">
                                                <input type="number" class="form-control" name="products[{{ $index }}][qty]" 
                                                       placeholder="Quantity" value="{{ $productSale->qty }}" required>
                                            </div>
                                            <div class="col-md-2">
                                                <input type="number" step="0.01" class="form-control" name="products[{{ $index }}][net_unit_price]" 
                                                       placeholder="Unit Price" value="{{ $productSale->net_unit_price }}" required>
                                            </div>
                                            <div class="col-md-2">
                                                <input type="number" step="0.01" class="form-control" name="products[{{ $index }}][total]" 
                                                       placeholder="Total" value="{{ $productSale->total }}" required>
                                            </div>
                                            <div class="col-md-2">
...
<script>
let productIndex = {{ count($productSales) }};
