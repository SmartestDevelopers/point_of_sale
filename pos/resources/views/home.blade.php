													...
													<div class="mt-3">
														<div class="d-flex align-items-center">
															<span class="text-dark font-weight-bold font-size-h1 me-3"><span
																	class="counter" data-bs-target="400">0</span></span>
														</div>
											...
											<div class="card card-custom gutter-b bg-white border-0 theme-circle theme-circle theme-circle-secondary">
												<div class="card-body">
													...
													<div class="mt-3">
														<div class="d-flex align-items-center">
															<span class="text-dark font-weight-bold font-size-h1 me-3"><span
																	class="counter" data-bs-target="600">0</span></span>
														</div>
														<div class="text-black-50 mt-3">Compare to last year (2019)</div>
													</div>
												</div>
											...
											<div class="card card-custom gutter-b bg-white border-0 theme-circle theme-circle-success">
												<div class="card-body">
													...
													<div class="mt-3">
														<div class="d-flex align-items-center">
															<span class="text-dark font-weight-bold font-size-h1 me-3"><span
																	class="counter" data-bs-target="1000">0</span></span>
														</div>
														<div class="text-black-50 mt-3">Compare to last year (2019)</div>
													</div>
												</div>
											...
											<div class="card card-custom gutter-b bg-white border-0 theme-circle theme-circle-info">
												<div class="card-body">
													...
													<div class="mt-3">
														<div class="d-flex align-items-center">
															<span class="text-dark font-weight-bold font-size-h1 me-3">$<span
																	class="counter" data-bs-target="6800">0</span></span>
															<span
